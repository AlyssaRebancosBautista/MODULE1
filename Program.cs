                ...
                while (true)
                {
                    ...
                    try
                    {
                        switch (choice)
                        {
                            ...
                            case 2: 
                                Console.Write("Enter your Product ID to retrieve: ");
                            ...
                            case 3: 
                                Console.Write("Enter your Product ID to update: ");
                                int updateId = int.Parse(Console.ReadLine());
                                Console.Write("Enter your new Product Name: ");
                                string updateName = Console.ReadLine();
                                productRepo.Update(updateId, new Product { ProductId = updateId, ProductName = updateName });
                                Console.WriteLine("Your Product updated successfully.");
                                break;

                            case 4: 
                                Console.Write("Enter your Product ID to delete: ");
                                int deleteId = int.Parse(Console.ReadLine());
                                productRepo.Delete(deleteId);
                                Console.WriteLine("Your Product deleted successfully.");
                                break;
                        }
                    }
                    catch (Exception ex)
